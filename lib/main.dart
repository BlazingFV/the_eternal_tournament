      ...
      builder: (context, child) => GetMaterialApp(
        ...
        builder: (context, widget) => ResponsiveWrapper.builder(
          ...
          breakpoints: const [
            ...
            ResponsiveBreakpoint.resize(1400, name: DESKTOP, scaleFactor: 1),
            ResponsiveBreakpoint.resize(1500, name: DESKTOP, scaleFactor: 1),
            ResponsiveBreakpoint.resize(1600, name: DESKTOP, scaleFactor: 1),
            ResponsiveBreakpoint.autoScale(1700, name: 'XL', scaleFactor: 1.3),
            ResponsiveBreakpoint.autoScale(2460, name: '4K', scaleFactor: 1.5),
            ResponsiveBreakpoint.autoScale(2560, name: '4K', scaleFactor: 1.7),
          ],
        ),
        home: child,
      ),
